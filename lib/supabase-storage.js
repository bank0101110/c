...
// ฝั่ง client ย่อรูปให้ก่อนอัปแล้ว (lib/compress-image.js) ปกติจึงเหลือหลักร้อย KB
// เพดานนี้เป็นตาข่ายกันไฟล์ที่ย่อไม่ได้ เช่น GIF เคลื่อนไหว หรือคนยิง action ตรงเอง
